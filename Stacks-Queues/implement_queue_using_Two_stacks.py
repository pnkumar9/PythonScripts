...
A sequence of elements pushed on a stack comes back in reversed order when popped. Consequently, 
...
elements from an out-stack. If the out-stack is empty we pop all elements from the in-stack 
